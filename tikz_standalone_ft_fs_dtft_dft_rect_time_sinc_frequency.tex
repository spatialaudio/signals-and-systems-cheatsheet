...
\begin{document}
	\begin{tikzpicture}[
		...
		$};
		%DFT
		\node[anchor=north west] at (45/64*\paperwidth,2/20*\paperheight) (DFTequation) {$
		x[k]=\frac{1}{N} \sum\limits_{\mu=0}^{N-1} X[\mu] \e^{+\im \frac{2 \pi}{N} \mu k}
		\qquad
		X[\mu]=\sum\limits_{k=0}^{N-1} x[k] \e^{-\im \frac{2 \pi}{N} k \mu}
		$};
		%FS
		\node[anchor=north west] at (43.5/64*\paperwidth,19.2/20*\paperheight) (FSequation) {$
		x(t)=\frac{1}{T_0} \sum\limits_{\mu=-\infty}^{+\infty} \tilde{X}[\mu] \e^{+\im \frac{2 \pi}{T_0} \mu t}
		\qquad
		\tilde{X}[\mu]=\int\limits_{t=\frac{-T_0}{2}}^{\frac{+T_0}{2}} x(t) \e^{-\im \frac{2 \pi}{T_0} t \mu} \fsd t
		$};



		\node[anchor=north west] at (40/128*\paperwidth,2/128*\paperheight) (author) {\tiny Robert Hauser, Frank Schultz, University of Rostock, \url{https://github.com/spatialaudio/signals-and-systems-cheatsheet}, CC BY 4.0, 2025-05-22};
		%
		% FT Plots
		%
		% rect time domain
		...
		\begin{axis}[
			...
			mark size = \MARKSIZE,]
			{\Th*sinc(x*pi*\Th/\T)};
			\node[anchor=center] at (axis cs:-2.5,2) {\FONTSIZE $A T_h$};
			\node[anchor=center] at (axis cs:-7.5,1) {\FONTSIZE here for $\frac{T_h}{T_0}=\frac{2}{5}$};
		\end{axis}
		%
		%
		%
		...
		\begin{axis}[
			...
			mark size = \MARKSIZE,]
			{RECT(x+2,5)};
			\node[anchor=center] at (axis cs:-3.5,1) {\FONTSIZE $A$};
		\end{axis}
		%
		% rect frequency domain
		%
		\begin{axis}[
			...
			\LINEWIDTH,]
			{diric(x,5)};
			\node[anchor=center] at (axis cs:-2*pi/5-0.5,5) {\FONTSIZE $A K_h$};
		\end{axis}
		%
		%
		%
		...
		\begin{axis}[
			...
			{diric2(x,5,10)};
			\node[anchor=center] at (axis cs:-2,5) {\FONTSIZE $5 A$};
		\end{axis}
		%
		%
		%
		...
		%
		\node at (22/40*\paperwidth,25/32*\paperheight) [align=center,color=\FCOLOR] {\Huge ${\omega}$};
		%
		% t between FT and FS
		%
		\node at (18/40*\paperwidth,25/32*\paperheight) [align=center,color=\TCOLOR] {\Huge ${t}$};
		%
		...
		%
		\node at (22/40*\paperwidth,28/32*\paperheight) [align=center,color=\FCOLOR] {\Huge ${\cdot\Sha}$};
		%
		\node at (18/40*\paperwidth,28/32*\paperheight) [align=center,color=\TCOLOR] {\Huge ${\ast\Sha}$};
		%
		% closed arrow from FS to FT
		%
		\draw[C1,thick,latex-] (17/40*\paperwidth,24/32*\paperheight)  -- (23/40*\paperwidth,24/32*\paperheight) node[below] {Interpolation};
		%
		% convolution sinc closed arrow
		%
		\node at (22/40*\paperwidth,22/32*\paperheight) [align=center,color=\FCOLOR] {\huge ${\ast\sinc}$};
		%
		% multiplication rect closed arrow
		%
		\node at (18/40*\paperwidth,22/32*\paperheight) [align=center,color=\TCOLOR] {\huge ${\cdot\rect}$};
		%
		%
		%
		%
		...
		%
		\node at (22/40*\paperwidth,7/32*\paperheight) [align=center,color=\FCOLOR] {\Huge ${\omega}$};
		%
		% t between DTFT and DFT
		%
		\node at (18/40*\paperwidth,7/32*\paperheight) [align=center,color=\TCOLOR] {\Huge ${t}$};
		%
		...
		%
		\node at (22/40*\paperwidth,10/32*\paperheight) [align=center,color=\FCOLOR] {\Huge ${\cdot\Sha}$};
		%
		\node at (18/40*\paperwidth,10/32*\paperheight) [align=center,color=\TCOLOR] {\Huge ${\ast\Sha}$};
		%
		% closed arrow from DFT to DTFT
		%
		\draw[C1,thick,latex-] (17/40*\paperwidth,6/32*\paperheight) -- (23/40*\paperwidth,6/32*\paperheight) node[below]{Interpolation};
		%
		% convolution sinc closed arrow
		%
		\node at (22/40*\paperwidth,4/32*\paperheight) [align=center,color=\FCOLOR] {\huge ${\ast\psinc}$};
		%
		% multiplication rect closed arrow
		%
		\node at (18/40*\paperwidth,4/32*\paperheight) [align=center,color=\TCOLOR] {\huge ${\cdot\rect}$};
		%
		%
		%
		...
		%
		\node at (1/5*\paperwidth,18/40*\paperheight) [align=center,color=\FCOLOR,] {\Huge ${\omega}$};
		%
		% t between FT amd FS
		%
		\node at (1/5*\paperwidth,22/40*\paperheight) [align=center,color=\TCOLOR,] {\Huge ${t}$};
		%
		...
		% dirac comb open arrow
		%
		\node at (10/32*\paperwidth,18/40*\paperheight) [align=center,color=\FCOLOR,] {\Huge ${\ast\Sha}$};
		%
		\node at (10/32*\paperwidth,22/40*\paperheight) [align=center,color=\TCOLOR,] {\Huge ${\cdot\Sha}$};
		%
		...
		%
		\node at (4/6*\paperwidth,18/40*\paperheight) [align=center,color=\FCOLOR,] {\Huge ${\omega}$};
		%
		% t between FS and DFT
		%
		\node at (4/6*\paperwidth,22/40*\paperheight) [align=center,color=\TCOLOR,] {\Huge ${t}$};
		%
		...
		% dirac comb open arrow
		%
		\node at (25/32*\paperwidth,18/40*\paperheight) [align=center,color=\FCOLOR,] {\Huge ${\ast\Sha}$};
		%
		\node at (25/32*\paperwidth,22/40*\paperheight) [align=center,color=\TCOLOR] {\Huge ${\cdot\Sha}$};
		%
		%
